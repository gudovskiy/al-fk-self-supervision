...
parser.add_argument('-smp', '--sample-steps', type=int, default=64, metavar='N',
                    help='number of samples for estimation (default: 64)')
...
parser.add_argument('-gbs', '--gen-batch-size', type=int, default=5000, metavar='N',
                    help='batch size for descriptor generation (default: 5000)')
...
bSize = 1250 # batch increment in images
irs = [1,100] # imbalance ratios instead of ir = args.imbalance_ratio
#irs = [100]
msa = [768,256] # descriptor lengths for multiscale aggregation
#msa = [768]
