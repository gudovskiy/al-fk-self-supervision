...
class MNIST(data.Dataset):
    ...
    def __init__(self, root, run_folder='run99', train=False, val=False, transform=None, target_transform=None, download=False, train_list=[], imbalance_ratio=1, noisy_ratio=0.0):
