...
class SVHN(data.Dataset):
    ...
    def __init__(self, root, run_folder='run99', train=False, val=False, extra=True, transform=svhn_transformer(), target_transform=None, download=False, train_list=[], imbalance_ratio=1, noisy_ratio=0.0):
